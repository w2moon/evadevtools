...
export default function pixiDevtoolsProperties(devtools: PixiDevtools) {
  ...
  function getPropDefinition(
    ...
    if (!(node as any)[metaProperty]) {
      ...
      objectDefs.push(...directProp(node, "xEva", "number"));
      objectDefs.push(...directProp(node, "yEva", "number"));
      ...
      objectDefs.push(...directProp(node, "widthEva", "number"));
      objectDefs.push(...directProp(node, "heightEva", "number"));
